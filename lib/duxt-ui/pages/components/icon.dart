  ...
  Component build(BuildContext context) {
    return AppScaffold(
      ...
      body: Component.fragment([
        h1([Component.text('Icon')]),
            p(classes: 'text-xl text-zinc-500 dark:text-zinc-400', [
              Component.text('An icon component powered by Iconify, supporting thousands of icons from popular icon sets.'),
            ]),
...
DIcon(name: 'lucide:heart')'''),
            ...
            _section('Using DIconNames', [
              p(classes: 'text-zinc-400 mb-4 text-sm', [
                Component.text('Duxt UI provides DIconNames class with commonly used icon names for convenience.'),
              ]),
              ComponentPreviewCard(preview: [
                div(classes: 'flex items-center gap-4', [
              ...
              ], code: '''DIcon(name: DIconNames.home)
DIcon(name: DIconNames.user)
DIcon(name: DIconNames.settings)
DIcon(name: DIconNames.mail)
DIcon(name: DIconNames.heart)'''),
              ...
              ComponentPreviewCard(preview: [
                div(classes: 'flex items-end gap-4', [
                  div(classes: 'flex flex-col items-center gap-2', [
                    ...
                    span(classes: 'text-xs text-zinc-500', [Component.text('xs')]),
                  ]),
                  div(classes: 'flex flex-col items-center gap-2', [
                    DIcon(name: DIconNames.star, size: DIconSize.sm),
                    span(classes: 'text-xs text-zinc-500', [Component.text('sm')]),
                  ]),
                  div(classes: 'flex flex-col items-center gap-2', [
                    DIcon(name: DIconNames.star, size: DIconSize.md),
                    span(classes: 'text-xs text-zinc-500', [Component.text('md')]),
                  ]),
                  div(classes: 'flex flex-col items-center gap-2', [
                    DIcon(name: DIconNames.star, size: DIconSize.lg),
                    span(classes: 'text-xs text-zinc-500', [Component.text('lg')]),
                  ]),
                  div(classes: 'flex flex-col items-center gap-2', [
                    DIcon(name: DIconNames.star, size: DIconSize.xl),
                    span(classes: 'text-xs text-zinc-500', [Component.text('xl')]),
                  ]),
                ]),
              ], code: '''DIcon(name: DIconNames.star, size: DIconSize.xs)  // 16px
...
DIcon(name: DIconNames.star, size: DIconSize.xl)  // 40px'''),
            ...
            _section('Colors', [
              ...
              ], code: '''DIcon(name: DIconNames.heart, color: 'text-red-500')
DIcon(name: DIconNames.check, color: 'text-green-500')
DIcon(name: DIconNames.warning, color: 'text-yellow-500')
DIcon(name: DIconNames.info, color: 'text-blue-500')
DIcon(name: DIconNames.star, color: 'text-purple-500')'''),
            ...
            _section('Icon Sets', [
              p(classes: 'text-zinc-400 mb-4 text-sm', [
                Component.text('DIcon supports all Iconify icon sets. Use the format "set:icon-name".'),
              ]),
              ComponentPreviewCard(preview: [
                div(classes: 'flex items-center gap-4', [
                  div(classes: 'flex flex-col items-center gap-2', [
                    DIcon(name: 'lucide:rocket', size: DIconSize.lg),
                    span(classes: 'text-xs text-zinc-500', [Component.text('lucide')]),
                  ]),
                  div(classes: 'flex flex-col items-center gap-2', [
                    DIcon(name: 'heroicons:rocket-launch', size: DIconSize.lg),
                    span(classes: 'text-xs text-zinc-500', [Component.text('heroicons')]),
                  ]),
                  div(classes: 'flex flex-col items-center gap-2', [
                    DIcon(name: 'mdi:rocket', size: DIconSize.lg),
                    span(classes: 'text-xs text-zinc-500', [Component.text('mdi')]),
                  ]),
                  div(classes: 'flex flex-col items-center gap-2', [
                    DIcon(name: 'tabler:rocket', size: DIconSize.lg),
                    span(classes: 'text-xs text-zinc-500', [Component.text('tabler')]),
                  ]),
                  div(classes: 'flex flex-col items-center gap-2', [
                    DIcon(name: 'ph:rocket', size: DIconSize.lg),
                    span(classes: 'text-xs text-zinc-500', [Component.text('phosphor')]),
                  ]),
                ]),
              ], code: '''DIcon(name: 'lucide:rocket')
...
DIcon(name: 'ph:rocket')'''),
            ...
            _section('Navigation Icons', [
              ...
              ], code: '''DIcon(name: DIconNames.chevronLeft)
DIcon(name: DIconNames.chevronRight)
DIcon(name: DIconNames.chevronUp)
DIcon(name: DIconNames.chevronDown)
DIcon(name: DIconNames.arrowLeft)
DIcon(name: DIconNames.arrowRight)'''),
            ...
            _section('Action Icons', [
              ...
              ], code: '''DIcon(name: DIconNames.plus)
DIcon(name: DIconNames.minus)
DIcon(name: DIconNames.close)
DIcon(name: DIconNames.check)
DIcon(name: DIconNames.edit)
...
DIcon(name: DIconNames.copy)'''),
            ...
            _section('Status Icons', [
              ...
              ], code: '''DIcon(name: DIconNames.success, color: 'text-green-500')
DIcon(name: DIconNames.error, color: 'text-red-500')
DIcon(name: DIconNames.warning, color: 'text-yellow-500')
DIcon(name: DIconNames.info, color: 'text-blue-500')'''),
            ]),
...
DButton(
  ...
  color: DButtonColor.success,
            ...
            // Size Reference
            h3(classes: 'text-lg font-semibold text-white mt-6 mb-3', [Component.text('Size Reference')]),
            div(classes: 'not-prose overflow-x-auto', [
              table(classes: 'w-full text-sm', [
                thead(classes: 'border-b border-zinc-800', [
                  tr([
                    th(classes: 'text-left py-3 px-4 text-zinc-400', [Component.text('Size')]),
                    th(classes: 'text-left py-3 px-4 text-zinc-400', [Component.text('Value')]),
                    th(classes: 'text-left py-3 px-4 text-zinc-400', [Component.text('Pixels')]),
                  ]),
                ]),
                tbody([
  ...
  Component _iconShowcase(String name, String iconName) {
    return div(classes: 'flex items-center gap-3 p-3 rounded-lg bg-zinc-900/50 hover:bg-zinc-800/50 transition-colors', [
      ...
      span(classes: 'text-xs text-zinc-500 font-mono', [Component.text(name)]),
    ]);
  }
  ...
  Component _sizeRow(String size, String value, String pixels) {
    return tr(classes: 'border-b border-zinc-800/50', [
      td(classes: 'py-3 px-4 font-mono text-cyan-400', [Component.text(size)]),
      td(classes: 'py-3 px-4 font-mono text-purple-400', [Component.text(value)]),
      td(classes: 'py-3 px-4 text-zinc-700 dark:text-zinc-300', [Component.text(pixels)]),
    ]);
  }
}
