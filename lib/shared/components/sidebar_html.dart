...
/// Sidebar navigation for duxt_html documentation.
class SidebarHtml extends StatelessComponent {
  const SidebarHtml({super.key});
    ...
    return Component.fragment([
      ...
      nav(classes: 'sidebar-nav', [
        _group('Getting Started', [
          _link('Introduction', '/duxt-html'),
          _link('Getting Started', '/duxt-html/getting-started'),
        ]),
        _group('Reference', [
  ...
  static List<StyleRule> get _styles => [
    ...
    css('.sidebar-link', [
      ...
      css('&:hover').styles(
        ...
        color: Color('#10b981'), // emerald for html
      ),
    ]),
    ...
    css(':root[data-theme="light"] .sidebar-link', [
      ...
      css('&:hover').styles(
        ...
        color: Color('#059669'), // emerald for html
      ),
    ]),
  ];
}
