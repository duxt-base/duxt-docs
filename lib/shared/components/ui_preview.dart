  ...
  Component _buildPreview(String name) {
    ...
    return div(
      ...
      [
        // Live Preview area
        div(
          classes: 'p-8 bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center min-h-[180px]',
          [preview],
        ),
        // Code area
        div(
...
class UiPreviewCard extends CustomComponentBase {
  ...
  Component apply(String name, Map<String, String> attributes, Component? child) {
    ...
    return div(
      ...
      [
        div(
          classes: 'aspect-[4/3] bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center p-4',
          [preview],
        ),
