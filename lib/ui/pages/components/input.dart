      ...
      div(classes: 'flex flex-1 pt-16', [
        ...
        main_(classes: 'flex-1 p-8 max-w-4xl', [
          article(classes: 'prose dark:prose-invert max-w-none', [
            h1([text('Input')]),
            p(classes: 'text-xl text-zinc-500 dark:text-zinc-400', [text('Text input fields for user data entry.')]),

            _section('Basic Usage', [
              _preview([DInput(placeholder: 'Enter text...')], "DInput(placeholder: 'Enter text...')"),
            ]),
