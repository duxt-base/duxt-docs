      ...
      div(classes: 'flex flex-1 pt-16', [
        ...
        main_(classes: 'flex-1 p-8 max-w-4xl', [
          article(classes: 'prose dark:prose-invert max-w-none', [
            h1([text('Input Number')]),
            p(classes: 'text-xl text-zinc-500 dark:text-zinc-400', [text('Numeric input with increment/decrement controls.')]),
            _section('Basic Usage', [
              _preview([DInputNumber(value: 5)],
                'DInputNumber(value: 5)'),
            ]),
            _section('With Min/Max', [
              _preview([DInputNumber(value: 10, min: 0, max: 100)],
                'DInputNumber(value: 10, min: 0, max: 100)'),
            ]),
          ]),
        ]),
      ]),
