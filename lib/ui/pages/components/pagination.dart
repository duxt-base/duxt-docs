      ...
      div(classes: 'flex flex-1 pt-16', [
        ...
        main_(classes: 'flex-1 p-8 max-w-4xl', [
          article(classes: 'prose dark:prose-invert max-w-none', [
            h1([text('Pagination')]),
            p(classes: 'text-xl text-zinc-500 dark:text-zinc-400', [text('Page navigation controls.')]),
            _section('Basic Usage', [
              _preview([DPagination(currentPage: 3, totalPages: 10)],
                'DPagination(currentPage: 3, totalPages: 10)'),
            ]),
