      ...
      div(classes: 'flex flex-1 pt-16', [
        ...
        main_(classes: 'flex-1 p-8 max-w-4xl', [
          article(classes: 'prose dark:prose-invert max-w-none', [
            h1([text('Pin Input')]),
            p(classes: 'text-xl text-zinc-500 dark:text-zinc-400', [text('PIN/OTP code input with individual digit fields.')]),
            _section('Basic Usage', [
              _preview([DPinInput(length: 4)],
                'DPinInput(length: 4)'),
            ]),
            _section('Six Digits', [
              _preview([DPinInput(length: 6)],
                'DPinInput(length: 6)'),
            ]),
          ]),
        ]),
