      ...
      div(classes: 'flex flex-1 pt-16', [
        ...
        main_(classes: 'flex-1 p-8 max-w-4xl', [
          article(classes: 'prose dark:prose-invert max-w-none', [
            h1([text('Progress')]),
            p(classes: 'text-xl text-zinc-500 dark:text-zinc-400', [text('Visual indicators for task completion.')]),

            _section('Basic Usage', [
              _preview([div(classes: 'w-full max-w-sm', [DProgress(value: 50)])], 'DProgress(value: 50)'),
            ]),
