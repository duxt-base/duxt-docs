      ...
      div(classes: 'flex flex-1 pt-16', [
        ...
        main_(classes: 'flex-1 p-8 max-w-4xl', [
          article(classes: 'prose dark:prose-invert max-w-none', [
            h1([text('Separator')]),
            p(classes: 'text-xl text-zinc-500 dark:text-zinc-400', [text('Visual dividers between content sections.')]),
            _section('Horizontal', [
              _preview([div(classes: 'w-full max-w-sm', [
                div(classes: 'text-zinc-400 text-sm', [text('Section 1')]),
                DSeparator(classes: 'my-4'),
                div(classes: 'text-zinc-400 text-sm', [text('Section 2')]),
              ])], 'DSeparator()'),
            ]),
          ]),
        ]),
