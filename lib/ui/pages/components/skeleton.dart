      ...
      div(classes: 'flex flex-1 pt-16', [
        ...
        main_(classes: 'flex-1 p-8 max-w-4xl', [
          article(classes: 'prose dark:prose-invert max-w-none', [
            h1([text('Skeleton')]),
            p(classes: 'text-xl text-zinc-500 dark:text-zinc-400', [text('Loading placeholders for content.')]),
            _section('Basic Usage', [
              _preview([div(classes: 'w-full max-w-sm space-y-3', [DSkeleton(classes: 'h-4 w-full'), DSkeleton(classes: 'h-4 w-3/4'), DSkeleton(classes: 'h-4 w-1/2')])],
                "DSkeleton(classes: 'h-4 w-full')\nDSkeleton(classes: 'h-4 w-3/4')"),
            ]),
            _section('Card Skeleton', [
              _preview([div(classes: 'w-full max-w-sm p-4 border border-zinc-800 rounded-lg space-y-4', [
