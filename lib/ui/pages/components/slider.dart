      ...
      div(classes: 'flex flex-1 pt-16', [
        ...
        main_(classes: 'flex-1 p-8 max-w-4xl', [
          article(classes: 'prose dark:prose-invert max-w-none', [
            h1([text('Slider')]),
            p(classes: 'text-xl text-zinc-500 dark:text-zinc-400', [text('Range slider for value selection.')]),
            _section('Basic Usage', [
              _preview([div(classes: 'w-64', [DSlider(value: 50)])],
                'DSlider(value: 50)'),
            ]),
            _section('With Min/Max', [
              _preview([div(classes: 'w-64', [DSlider(value: 25, min: 0, max: 100)])],
                'DSlider(value: 25, min: 0, max: 100)'),
            ]),
          ]),
        ]),
      ]),
