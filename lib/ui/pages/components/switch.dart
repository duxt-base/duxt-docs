      ...
      div(classes: 'flex flex-1 pt-16', [
        ...
        main_(classes: 'flex-1 p-8 max-w-4xl', [
          article(classes: 'prose dark:prose-invert max-w-none', [
            h1([text('Switch')]),
            p(classes: 'text-xl text-zinc-500 dark:text-zinc-400', [text('Toggle switches for on/off states.')]),

            _section('Basic Usage', [
              _preview([div(classes: 'flex gap-4', [DSwitch(checked: false), DSwitch(checked: true)])],
