      ...
      div(classes: 'flex flex-1 pt-16', [
        ...
        main_(classes: 'flex-1 p-8 max-w-4xl', [
          article(classes: 'prose dark:prose-invert max-w-none', [
            h1([text('Textarea')]),
            p(classes: 'text-xl text-zinc-500 dark:text-zinc-400', [text('Multi-line text input field.')]),
            _section('Basic Usage', [
              _preview([DTextarea(placeholder: 'Enter your message...')],
                "DTextarea(placeholder: 'Enter your message...')"),
            ]),
            _section('With Label', [
              _preview([DTextarea(label: 'Description', placeholder: 'Enter description...')],
                "DTextarea(label: 'Description', placeholder: 'Enter description...')"),
            ]),
            _section('Disabled', [
              _preview([DTextarea(placeholder: 'Disabled textarea', disabled: true)],
                "DTextarea(placeholder: 'Disabled textarea', disabled: true)"),
            ]),
          ]),
        ]),
      ]),
